...
class SettingsCallback
{
	...
	{
		return require_once( get_template_directory() . '/template-parts/admin/index.php' );
	}
	...
	public function wtso_options_group( $input )
	{
		return $input;
	}

	public function wtso_admin_index()
	{
