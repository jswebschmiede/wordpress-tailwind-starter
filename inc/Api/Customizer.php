...
use Wtso\Api\Customizer\Sidebar;
use Wtso\Api\Customizer\Header;
use Wtso\Api\Customizer\Footer;
...
class Customizer
{
	...
	public function output()
	{
		echo '<!--Customizer CSS--> <style type="text/css">';
			echo self::css( '#sidebar', 'background-color', 'wtso_sidebar_background_color' );
			echo self::css( '.site-footer', 'background-color', 'wtso_footer_background_color' );
			echo self::css( '.site-header', 'background-color', 'wtso_header_background_color' );
			echo self::css( '.site-header', 'color', 'wtso_header_text_color' );
			echo self::css( '.site-header a', 'color', 'wtso_header_link_color' );
