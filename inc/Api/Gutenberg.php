...
class Gutenberg
{
	...
	{
		wp_register_script( 'gutenberg-wtso', get_template_directory_uri() . '/assets/dist/js/gutenberg.bundle.js', array( 'wp-blocks', 'wp-element', 'wp-editor' ) );

		register_block_type( 'gutenberg-wtso/wtso-cta', array(
			'editor_script' => 'gutenberg-wtso', // Load script in the editor
		) );
	}
	...
	{
		wp_enqueue_style( 'gutenberg-wtso-cta', get_template_directory_uri() . '/assets/dist/css/gutenberg.css', null );
	}
}
